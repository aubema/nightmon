...
while : ; do
	...
	echo "Shooting..."
	take_pictures
	y=`date --date="14 seconds ago" +%Y`
	mo=`date --date="14 seconds ago" +%m`
	dA=`date --date="14 seconds ago" +%d`
	basenameA=`date --date="14 seconds ago" +%Y-%m-%d_%H-%M-%S`
	basenameB=`date +%Y-%m-%d_%H-%M-%S`
	echo $basenameA
	baseday=`date --date="14 seconds ago" +%Y-%m-%d`
